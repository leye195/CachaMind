...
/*!***************************!*\
  !*** ./assets/js/chat.js ***!
  \***************************/
/*! exports provided: handleNewMessage, disableChat, enableChat */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleNewMessage\", function() { return handleNewMessage; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"disableChat\", function() { return disableChat; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"enableChat\", function() { return enableChat; });\n/* harmony import */ var _sockets__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sockets */ \"./assets/js/sockets.js\");\n //export const handleNotification = data => {\n//console.log(`${data.nickname} : ${data.message}`);\n//};\n\nvar chat__form = document.querySelector(\".chat__form\");\nvar jsMessage = document.getElementById(\"jsMessages\");\nvar chat__input = document.querySelector(\".chat__form input\");\n\nvar appendMessage = function appendMessage(nickname, msg) {\n  var li = document.createElement(\"li\");\n  li.innerHTML = \"<span class=\\\"author \".concat(nickname ? \"out\" : \"self\", \"\\\">\").concat(nickname ? nickname : \"You\", \"</span>: \").concat(msg);\n  jsMessage.appendChild(li);\n};\n\nvar handleSendMsg = function handleSendMsg(e) {\n  e.preventDefault();\n  var input = chat__form.querySelector(\"input\");\n  var value = input.value,\n      nickname = localStorage.getItem(\"USER_NAME\");\n  appendMessage(nickname, value);\n  Object(_sockets__WEBPACK_IMPORTED_MODULE_0__[\"getSocket\"])().emit(events.newMsg, {\n    nickname: nickname,\n    msg: value\n  });\n  input.value = \"\";\n};\n\nvar handleNewMessage = function handleNewMessage(_ref) {\n  var nickname = _ref.nickname,\n      msg = _ref.msg;\n  appendMessage(nickname, msg);\n};\nvar disableChat = function disableChat() {\n  chat__input.disabled = true;\n};\nvar enableChat = function enableChat() {\n  chat__input.disabled = false;\n};\n\nif (chat__form) {\n  chat__form.addEventListener(\"submit\", handleSendMsg);\n}\n\n//# sourceURL=webpack:///./assets/js/chat.js?");
...
/*!******************************!*\
  !*** ./assets/js/players.js ***!
  \******************************/
/*! exports provided: handleUpdate, handleStarted, handleTurn, handleEnded */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleUpdate\", function() { return handleUpdate; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleStarted\", function() { return handleStarted; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleTurn\", function() { return handleTurn; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleEnded\", function() { return handleEnded; });\n/* harmony import */ var _paint__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./paint */ \"./assets/js/paint.js\");\n/* harmony import */ var _chat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chat */ \"./assets/js/chat.js\");\n\n\nvar jsUsers = document.getElementById(\"jsUsers\");\nvar current_painter = document.querySelector(\"#jsGame h1\");\n\nvar addplayer = function addplayer(players) {\n  jsUsers.innerHTML = \"\";\n  players.forEach(function (player) {\n    var li = document.createElement(\"li\");\n    li.id = player.id;\n    li.innerHTML = \"<span>\".concat(player.nickname, \"</span> : <span>\").concat(player.points, \"</span>\");\n    jsUsers.appendChild(li);\n  });\n};\n\nvar setNotification = function setNotification(txt) {\n  current_painter.innerHTML = txt;\n};\n\nvar handleUpdate = function handleUpdate(_ref) {\n  var sockets = _ref.sockets;\n  return addplayer(sockets);\n};\nvar handleStarted = function handleStarted(_ref2) {\n  var painter = _ref2.painter;\n  //disable canavas event\n  current_painter.innerHTML = \"\";\n  current_painter.innerHTML = \"Painter: \".concat(painter.nickname);\n  Object(_paint__WEBPACK_IMPORTED_MODULE_0__[\"disableCanvas\"])();\n  Object(_chat__WEBPACK_IMPORTED_MODULE_1__[\"enableChat\"])(); //hide controls\n\n  Object(_paint__WEBPACK_IMPORTED_MODULE_0__[\"showWord\"])(\"\");\n  Object(_paint__WEBPACK_IMPORTED_MODULE_0__[\"hideControls\"])();\n};\nvar handleTurn = function handleTurn(_ref3) {\n  var word = _ref3.word;\n  Object(_paint__WEBPACK_IMPORTED_MODULE_0__[\"enableCanvas\"])();\n  Object(_chat__WEBPACK_IMPORTED_MODULE_1__[\"disableChat\"])();\n  Object(_paint__WEBPACK_IMPORTED_MODULE_0__[\"showControls\"])();\n  Object(_paint__WEBPACK_IMPORTED_MODULE_0__[\"showWord\"])(word);\n};\nvar handleEnded = function handleEnded() {\n  setNotification(\"Game Ended\");\n  Object(_paint__WEBPACK_IMPORTED_MODULE_0__[\"disableCanvas\"])();\n  Object(_chat__WEBPACK_IMPORTED_MODULE_1__[\"enableChat\"])();\n  Object(_paint__WEBPACK_IMPORTED_MODULE_0__[\"hideControls\"])();\n};\n\n//# sourceURL=webpack:///./assets/js/players.js?");
...
/*!******************************!*\
  !*** ./assets/js/sockets.js ***!
  \******************************/
/*! exports provided: getSocket, updateSocket, initSockets */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getSocket\", function() { return getSocket; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"updateSocket\", function() { return updateSocket; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"initSockets\", function() { return initSockets; });\n/* harmony import */ var _notification__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./notification */ \"./assets/js/notification.js\");\n/* harmony import */ var _chat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chat */ \"./assets/js/chat.js\");\n/* harmony import */ var _paint__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./paint */ \"./assets/js/paint.js\");\n/* harmony import */ var _players__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./players */ \"./assets/js/players.js\");\n/* harmony import */ var _timer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./timer */ \"./assets/js/timer.js\");\n\n\n\n\n\nvar socket = null;\nvar getSocket = function getSocket() {\n  return socket;\n};\nvar updateSocket = function updateSocket(asocket) {\n  return socket = asocket;\n};\nvar initSockets = function initSockets(asocket) {\n  var _window = window,\n      events = _window.events;\n  updateSocket(asocket);\n  asocket.on(events.newUser, _notification__WEBPACK_IMPORTED_MODULE_0__[\"handleNewUser\"]);\n  asocket.on(events.disconnected, _notification__WEBPACK_IMPORTED_MODULE_0__[\"handleDisconnect\"]);\n  asocket.on(events.newMsg, _chat__WEBPACK_IMPORTED_MODULE_1__[\"handleNewMessage\"]);\n  asocket.on(events.beganPath, _paint__WEBPACK_IMPORTED_MODULE_2__[\"handleBeganPath\"]);\n  asocket.on(events.strokedPath, _paint__WEBPACK_IMPORTED_MODULE_2__[\"handleStrokedPath\"]);\n  asocket.on(events.setFill, _paint__WEBPACK_IMPORTED_MODULE_2__[\"handleFill\"]);\n  asocket.on(events.cleaned, _paint__WEBPACK_IMPORTED_MODULE_2__[\"handleCleaned\"]);\n  asocket.on(events.playerUpdate, _players__WEBPACK_IMPORTED_MODULE_3__[\"handleUpdate\"]);\n  asocket.on(events.gameStarted, _players__WEBPACK_IMPORTED_MODULE_3__[\"handleStarted\"]);\n  asocket.on(events.painterNotification, _players__WEBPACK_IMPORTED_MODULE_3__[\"handleTurn\"]);\n  asocket.on(events.gameEnded, _players__WEBPACK_IMPORTED_MODULE_3__[\"handleEnded\"]);\n  asocket.on(events.timeUpdate, _timer__WEBPACK_IMPORTED_MODULE_4__[\"handleTimer\"]);\n};\n\n//# sourceURL=webpack:///./assets/js/sockets.js?");
...
/*!****************************!*\
  !*** ./assets/js/timer.js ***!
  \****************************/
/*! exports provided: handleTimer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleTimer\", function() { return handleTimer; });\n/* harmony import */ var _sockets__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sockets */ \"./assets/js/sockets.js\");\n\nvar timer = document.querySelector(\".time\");\nvar handleTimer = function handleTimer(_ref) {\n  var remain = _ref.remain;\n  var _window = window,\n      events = _window.events;\n  var time = \"0:\".concat(remain < 10 ? \"0\".concat(remain) : remain);\n  timer.innerHTML = time;\n\n  if (remain === 0) {\n    Object(_sockets__WEBPACK_IMPORTED_MODULE_0__[\"getSocket\"])().emit(events.timeOut);\n  }\n};\n\n//# sourceURL=webpack:///./assets/js/timer.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"../node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! /Users/yjlee/Documents/WorkSpace/CachaMind/src/assets/js/main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");
